...
model = dict(
    ...
    auxiliary_text_path = f'/mnt/disk2/arda_efe/graduation/ITACLIP/llama_generated_texts/{dataset_name}_synonyms.txt',
    slide_stride = 28,
    attn_self = True,
    def_coefficient = 0.1,
...
data_root = '/mnt/disk2/arda_efe/datasets/coco_object'
